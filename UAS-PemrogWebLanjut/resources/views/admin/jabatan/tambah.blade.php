                  ...
                  <form method="POST" action="{{ route('jabatan.store') }}">
                    ...
                    <div class="card-body">
                      <div class="form-group">
                        ...
                        <input type="text" name="jabatan" id="nama" class="form-control" placeholder="Masukan Nama">
                      </div>
                      <div class="form-group">
                        <label for="gaji">Gaji /Hari</label>
                        <input type="number" name="gaji" class="form-control" id="gaji" placeholder="Masukan Nominal">
                      </div>
                    </div>
                    <!-- /.card-body -->
