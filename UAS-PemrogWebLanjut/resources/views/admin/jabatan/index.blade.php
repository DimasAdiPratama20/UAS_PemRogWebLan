...
<div class="content-wrapper">
    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <div class="row">
          <div class="col-12">
            <a href="{{ route('jabatan.create') }}" class="btn btn-primary mb-3">Tambah Data Jabatan</a>
            <div class="card">
                <!-- /.card-header -->
                <div class="card-body">
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>Rp.{{ $d->nominal_gaji }} / Hari</td>
                            <td>
                                <a href="{{ route('jabatan.edit', ['id'=>$d->id]) }}" class="btn btn-primary"><i class="fa fa-pen"></i> Edit</a>
                            ...
                            <div class="modal-dialog">
                              <div class="modal-content">
                                ...
                                <div class="modal-body">
                                  <p>Apakah kamu yakin untuk menghapus data jabatan <b>{{ $d->nama_jabatan }}</b> ? </p>
                                </div>
