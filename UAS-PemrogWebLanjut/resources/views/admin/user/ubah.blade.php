                  ...
                  <form method="POST" action="{{ route('user.update', ['id'=>$data->id]) }}">
                    ...
                    <div class="card-body">
                      <div class="form-group">
                        ...
                        <input type="email" name="email" class="form-control" id="email" placeholder="Masukan Email" value="{{ $data->email }}">
                      </div>
                      <div class="form-group">
                        <label for="nama">Username</label>
                        <input type="text" name="username" id="nama" class="form-control" placeholder="Masukan Nama" value="{{ $data->username }}">
                      </div>
                      <div class="form-group">
                        <label for="nama">Nama Karyawan</label>
                        <select name="nama" id="nama" class="form-control">
                            @foreach ($nama as $nm)
                                <option value="{{ $nm }}" {{ $data->nama = $nm ? 'selected' : '' }}>{{ $nm }}</option>
                            @endforeach
                        </select>
                      </div>
                      <div class="form-group">
                      ...
                      <div class="form-group">
                        ...
                        <select name="role" id="role" class="form-control">
                            @foreach ($role as $rl)
                                <option value="{{ $rl }}" {{ $data->role == $rl ? 'selected' : ''}}>{{ $rl }}</option>
                            @endforeach
                        </select>
                      </div>
                    </div>
